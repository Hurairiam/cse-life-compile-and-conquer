...
_CATALOG_DATA: List[Tuple[str, str, int, List[str], bool, Optional[str], int]] = [
    ...
    ("AI_ETHICS", "AI Ethics", 3, [], False, None, 2),
...
_QUESTION_DATA: Dict[str, Dict[str, Tuple[str, List[str], str]]] = {
    ...
    "AI_ETHICS": {
        "easy": ("A hiring algorithm trained on a company's historical data consistently ranks male candidates higher than female candidates for engineering roles. This is an example of:", ["The Halting Problem", "Algorithmic Bias / Data Bias", "Overfitting", "Data Anonymization"], "B"),
        "medium": ("In the context of autonomous vehicles facing an unavoidable accident, which classical ethical dilemma is most commonly referenced when programming decision-making protocols?", ["The Prisoner's Dilemma", "The Ship of Theseus", "The Trolley Problem", "The Tragedy of the Commons"], "C"),
        "hard": ("Which concept refers to the requirement that an AI system's inner workings and decision-making processes can be understood and audited by humans?", ["Scalability", "Convergence", "Latency", "Explainability (or Transparency)"], "D"),
    },
    "MAT1201": {
